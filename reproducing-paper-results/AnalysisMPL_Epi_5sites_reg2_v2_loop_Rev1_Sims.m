...
% code for 5-site simulation Figure 7
...
numStrainsInInitialPop = 5; % 5, 10, 20
%L = 50;
allSets = [1068141 1068144 1068241 1068244 1068143 1068142 1068243 1068242];

allNumItr = [1000*ones(1, length(allSets))];
