...
saveFigs = 0;
% Lin = 10;
thisSet = 1064701%1062001;%1065401%1064701;%1065401;%1062001;%1065401;%1064701;%1062001;%1065401;%1064701%1066881;%1064701;%1062001;%1064701;%1062001;%1062401%1062301;%1064101%10603%1061003%10603%5611001%46%58%1991;%1990;%42%87%58%5%87%5;
...
sigmaEstOutIllingEpiItr = -1*ones(numItr, 15);
...
aucIllingEpiItr = -1*ones(numItr,2);
...
aucIllingEpiSelcItr = -1*ones(numItr,2);
...
aucIllingEpi_only_si_Itr = -1*ones(numItr,2);
...
aucIllingEpi_only_sij_Itr = -1*ones(numItr,2);
aucLinkEpi_only_si_SelcItr = -1*ones(numItr,2);
aucIllingEpi_only_si_SelcItr = -1*ones(numItr,2);
aucLinkEpi_only_sij_SelcItr = -1*ones(numItr,2);
aucIllingEpi_only_sij_SelcItr = -1*ones(numItr,2);
...
allEstIllingEpiItr = zeros(numItr, numParam);
    ...
    if(recombination == 1)
        if(dataFilesWith2Regs == 1)
            if(Tstart == 1)
                ...
                fileNameIlling = ['WFsimEpi_Nmu' NmuInStr '_Nr' NrInStr '_N' num2str(Nin) '_L' num2str(Lin) '_D' num2str(DAll) '_Dele' num2str(DeleAll) '_selVal' num2str(selVal) '_delSelVal' num2str(delSelVal) '_initStr' num2str(numStrainsInInitialPop) '_' num2str(actualT) 'k_' num2str(itr) '_Tend' num2str(Tend) '_dts' num2str(dT) '_ng' num2str(ng) '_Illing_Set' num2str(thisSet) '_itr' num2str(itr) '.mat'];
            else        
        ...
        load([dirNameAnalysis fileName], 'L', 'perSiteSelction', 'perSiteSelctionEpi', 'muVal', ...
         ...
         load([dirNameAnalysis fileNameIlling], 'allEpiEstIlling', 'timeWholeCodeIlling')
    else
        if(dataFilesWith2Regs == 1)
            if(Tstart == 1)
                ...
                fileNameIlling = ['WFsimEpi_Nmu' NmuInStr '_N' num2str(Nin) '_L' num2str(Lin) '_D' num2str(DAll) '_Dele' num2str(DeleAll) '_selVal' num2str(selVal) '_delSelVal' num2str(delSelVal) '_initStr' num2str(numStrainsInInitialPop) '_' num2str(actualT) 'k_' num2str(itr) '_Tend' num2str(Tend) '_dts' num2str(dT) '_ng' num2str(ng) '_Illing_Set' num2str(thisSet) '_itr' num2str(itr) '.mat'];
            else        
                fileName = ['WFsimEpi_Nmu' NmuInStr '_N' num2str(Nin) '_L' num2str(Lin) '_D' num2str(DAll) '_Dele' num2str(DeleAll) '_selVal' num2str(selVal) '_delSelVal' num2str(delSelVal) '_initStr' num2str(numStrainsInInitialPop) '_' num2str(actualT) 'k_' num2str(itr) '_Tstart' num2str(Tstart) '_Tend' num2str(Tend) '_dts' num2str(dT) '_ng' num2str(ng) '_linkDiff' '_reg1' regStr1 '_reg2' regStr2 '_Set' num2str(thisSet) '_itr' num2str(itr) '.mat'];
            end        
        else
...
%     pause
    ...
    sigmaEstOutIllingEpi = allEpiEstIlling(itr,:)';
    ...
    sigmaEstOutIllingEpiItr(itr,:) = sigmaEstOutIllingEpi';
...
%      end
    ...
    if(postFiltering == 1)
        ...
        sigmaEstOutIllingEpiSelc = sigmaEstOutIllingEpiItr(selcSitesEpi);
    ...
    [aucIllingEpiItrTemp, aucIllingEpiSelcItrTemp] = calcAUROC(perSiteSelctionAllEpiTerms, perSiteSelctionAllEpiTermsSelc, sigmaEstOutIllingEpi, sigmaEstOutIllingEpiSelc, posOnlyItrTemp_AllEpiTerms, negOnlyItrTemp_AllEpiTerms, posOnlySelcItrTemp_AllEpiTerms, negOnlySelcItrTemp_AllEpiTerms);
    ...
    sigmaEstOutIllingEpi_only_si = sigmaEstOutIllingEpi(sitesEpi_only_si);
    sigmaEstOutIllingEpi_only_si_Selc = sigmaEstOutIllingEpi(selcSitesEpi_only_si);
    ...
    [aucIllingEpiItrTemp_only_si, aucIllingEpiSelcItrTemp_only_si] = calcAUROC(perSiteSelction_only_si, perSiteSelction_only_si_Selc, sigmaEstOutIllingEpi_only_si, sigmaEstOutIllingEpi_only_si_Selc, posOnlyItrTemp_only_si, negOnlyItrTemp_only_si, posOnlySelcItrTemp_only_si, negOnlySelcItrTemp_only_si);
    ...
    sigmaEstOutIllingEpi_only_sij = sigmaEstOutIllingEpi(sitesEpi_only_sij);
    sigmaEstOutIllingEpi_only_sij_Selc = sigmaEstOutIllingEpi(selcSitesEpi_only_sij);
    ...
    [aucIllingEpiItrTemp_only_sij, aucIllingEpiSelcItrTemp_only_sij] = calcAUROC(perSiteSelction_only_sij, perSiteSelction_only_sij_Selc, sigmaEstOutIllingEpi_only_sij, sigmaEstOutIllingEpi_only_sij_Selc, posOnlyItrTemp_only_sij, negOnlyItrTemp_only_sij, posOnlySelcItrTemp_only_sij, negOnlySelcItrTemp_only_sij);
...
%         pause
    ...
    aucIllingEpiItr(itr,:) = aucIllingEpiItrTemp;
    ...
    aucIllingEpiSelcItr(itr,:) = aucIllingEpiSelcItrTemp;
    ...
    aucIllingEpi_only_si_Itr(itr,:) = aucIllingEpiItrTemp_only_si;
    aucIllingEpi_only_sij_Itr(itr,:) = aucIllingEpiItrTemp_only_sij;
    ...
    aucIllingEpi_only_si_SelcItr(itr,:) = aucIllingEpiSelcItrTemp_only_si;
    aucIllingEpi_only_sij_SelcItr(itr,:) = aucIllingEpiSelcItrTemp_only_sij;
    ...
    allEstIllingEpiItr(itr,:) = sigmaEstOutIllingEpi';
...
mean(aucIllingEpi_only_si_Itr(aucIllingEpi_only_si_Itr(:,1) ~= -1,1)) mean(aucIllingEpi_only_si_Itr(aucIllingEpi_only_si_Itr(:,2) ~= -1,2)) mean(aucIllingEpi_only_si_SelcItr(aucIllingEpi_only_si_SelcItr(:,1) ~= -1,1)) mean(aucIllingEpi_only_si_SelcItr(aucIllingEpi_only_si_SelcItr(:,2) ~= -1,2));
mean(aucIllingEpi_only_sij_Itr(aucIllingEpi_only_sij_Itr(:,1) ~= -1,1)) mean(aucIllingEpi_only_sij_Itr(aucIllingEpi_only_sij_Itr(:,2) ~= -1,2)) mean(aucIllingEpi_only_sij_SelcItr(aucIllingEpi_only_sij_SelcItr(:,1) ~= -1,1)) mean(aucIllingEpi_only_sij_SelcItr(aucIllingEpi_only_sij_SelcItr(:,2) ~= -1,2));

]
disp('-------------------------------')

fileNameSave = ['WFsimEpi_Nmu' NmuInStr '_N' num2str(Nin) '_L' num2str(Lin) '_D' num2str(DAll) '_Dele' num2str(DeleAll) '_selVal' num2str(selVal) '_delSelVal' num2str(delSelVal) '_initStr' num2str(numStrainsInInitialPop) '_' num2str(actualT) 'k_' num2str(numItr) '_Tend' num2str(Tend) '_dts' num2str(dT) '_ng' num2str(ng) '_linkDiff_Illing_reg1' regStr1 '_reg2' regStr2 '_Set' num2str(thisSet) '_itr1_' num2str(numItr) '.mat'];
