classdef circularGraph_noButtons < handle
    ...
    methods
        function this = circularGraph_noButtons(adjacencyMatrix,varargin)
            ...
            addParameter(p,'ColorMap',defaultColorMap,@(colormap)length(colormap) == 4);
...
%                 'UserData',this);
            ...
            for i = 1:length(adjacencyMatrix)
                ...
                elseif(adjacencyMatrix(i,i) == 0)
                    this.Node(i).Color = this.ColorMap(1,:);
                elseif(adjacencyMatrix(i,i) > 0)
                    this.Node(i).Color = this.ColorMap(2,:);
                elseif(adjacencyMatrix(i,i) < 0)
                    this.Node(i).Color = this.ColorMap(3,:);
                elseif(isnan(adjacencyMatrix(i,i)))
                    this.Node(i).Color = this.ColorMap(4,:);
                end
