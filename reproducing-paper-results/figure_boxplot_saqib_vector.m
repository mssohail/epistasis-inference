function bh = figure_boxplot_saqib_vector(data_input, G_input, ...
...
no_boxplots = length(unique(G_input));
...
if no_boxplots>90 || isempty(data_input)
...
% figure;
bh = boxplot(data,G,...
    'whisker',whisker_value,'jitter',outlier_jitter_value,...
