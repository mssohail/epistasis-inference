classdef circularGraph_noButtons_colorGradient_small < handle
    ...
    methods
        function this = circularGraph_noButtons_colorGradient_small(adjacencyMatrix,varargin)
            % Constructor
            p = inputParser;
...
%                 'UserData',this);
            ...
            for i = 1:length(adjacencyMatrix)
                this_v = abs(adjacencyMatrix(i, i));
                [i this_v]
