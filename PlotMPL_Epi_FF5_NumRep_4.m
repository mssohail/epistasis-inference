...
%    aucLinkEpi_only_si_Itr(:,1)
    ...
    axis([0 1.2 0 1])
    %title(['\fontsize{8}' num2str(thisRep) ' rep.'])
    title(['\fontsize{8} No. of rep.: ' num2str(thisRep)])
...
title('\fontsize{8}All selection coefficients')
...
title('\fontsize{8}Accessible selection coefficients')
% xlabh = get(gca,'xlabel'); 
% set(xlabh,'Units','normalized');
% set(xlabh,'position',get(xlabh,'position') + [-0.1 0 0]);
...
title('\fontsize{8}All epistasis terms')
% xlabh = get(gca,'xlabel'); 
% set(xlabh,'Units','normalized');
% set(xlabh,'position',get(xlabh,'position') + [-0.1 0 0]);
% leg = legend('Beneficial', 'Deleterious', 'location', 'NorthEast');
...
for jj = 1:3
    ...
    if(jj==1)
        title(['\fontsize{8} No. of rep.: ' num2str(numRep1)])
    elseif(jj==2)
        title(['\fontsize{8} No. of rep.: ' num2str(numRep2)])
    elseif(jj==3)
        title(['\fontsize{8} No. of rep.: ' num2str(numRep3)])
    end
...
textLeg1 = annotation('textbox',dimDummy,'String','Beneficial','FitBoxToText','on')
textLeg1.Units = 'centimeter';
textLeg1.Position = [10.4 3.3+vgap2+height11 2 0.5];
textLeg1.LineStyle = 'none';
...
textLeg2 = annotation('textbox',dimDummy,'String','Deleterious','FitBoxToText','on')
textLeg2.Units = 'centimeter';
textLeg2.Position = [10.4 2.9+vgap2+height11 2 0.5];
textLeg2.LineStyle = 'none';
...
te1 = annotation('textbox',dimDummy,'String','No. of rep.: 1','FitBoxToText','on')
...
te2 = annotation('textbox',dimDummy,'String','No. of rep.: 3','FitBoxToText','on')
...
te3 = annotation('textbox',dimDummy,'String','No. of rep.: 5','FitBoxToText','on')
...
tlegA6.Position = [4.55 12.4 6 0.5];%[5.8 4.1 0.7 0.5];
...
tlegA7.Position = [4.4 10.9 6 0.5];%[5.8 4.1 0.7 0.5];
...
tlegA8.Position = [4.9 9.3 6 0.5];%[5.8 4.1 0.7 0.5];
