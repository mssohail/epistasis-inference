...
%    aucLinkEpi_only_si_Itr(:,1)
    ...
    %ylim([0 1000])
    axis([0 1.2 0 1])
    title(['\fontsize{8} No. of GT:' num2str(numStrainsInInitialPop)])
...
%ylabel('AUROC')
%xlabel('Number of unique genotypes')
title('\fontsize{8}Accessible epistasis terms')
...
for jj = 1:3
    ...
    axis([0 1.2 0 1])
    if(jj==1)
        title(['\fontsize{8} No. of GT:' num2str(numStrainsInInitialPop1)])
    elseif(jj==2)
        title(['\fontsize{8} No. of GT:' num2str(numStrainsInInitialPop2)])
    elseif(jj==3)
        title(['\fontsize{8} No. of GT:' num2str(numStrainsInInitialPop3)])
    end
...
te1 = annotation('textbox',dimDummy,'String','No. of GT: 5','FitBoxToText','on')
...
te2 = annotation('textbox',dimDummy,'String','No. of GT:10','FitBoxToText','on')
...
te3 = annotation('textbox',dimDummy,'String','No. of GT: 20','FitBoxToText','on')
