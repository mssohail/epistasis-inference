% all box edges can be different color

function [] = boxplot2_long_color(dataCell, thisBoxColor, boxWidth, thisWhiskerColor, whiskerLineWidth, whiskerLineStyle, thisBoxEdgeColor, boxLineWidth, thisMedianColor, medianLineWidth)
...
for i = 1:length(dataCell)
    ...
    whiskerColor = thisWhiskerColor(i,:);
    boxEdgeColor = thisBoxEdgeColor(i,:);
    medianColor = thisMedianColor(i,:);
