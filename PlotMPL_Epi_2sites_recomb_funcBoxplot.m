...
% Box plot of selection estimates: model with epistasis and recomb
subplot(3,12,[13:21])
figure_boxplot_saqib(allEstEpiWithR,label_axes_1,label_boxes_epi, ' ', 'horizontal',color_scheme_npg);
hold on
set(gca,...
    'TickLabelInterpreter','latex',...%'XTickLabel',label_boxes_epi,...
    'FontSize', 10, ...
...
plot(0:0.1:4, zeros(1, length(0:0.1:4)), 'r:')
title('MPL Model with epistasis and recomb')
axis([0.5 3.5 -0.075 0.075])
...
% Box plot of NRMSE selection estimates: model with epistasis with rcomb
subplot(3,12,[22:23])
figure_boxplot_saqib(allNRMSEEpiWithR',{' ', ' '}, {' '}, ' ', 'horizontal',color_scheme_npg);
hold on
set(gca,...
    'TickLabelInterpreter','latex',...
    'XTickLabel',{' '},...
